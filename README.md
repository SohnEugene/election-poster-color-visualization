...
선거 기간에는 선관위 홈페이지에 정책공약 마당에서 모든 후보의 공보물을 확인할 수 있었기에 그 표지를 벽보 대용으로 하여 분석할 계획이었다.
벽보와 공보물 표지가 상당히 유사한 경우가 다수 있었기에 세웠던 계획이었다.
...
<br/>
<br/>
그러나 선거 다음날 바로 선관위 정책공약마당에서 낙선한 후보자들의 공보물이 내려갔다. 
선관위에 문의한 결과, 위 공보물들은 개인정보 보호를 위해 내려갔으며 선관위 도서관 홈페이지에 아키이빙되기까지는 2-3개월이 소요된다는 답변을 받았다.
그러나 같은 해 11월까지 선관위 도서관 사이트에 22대 총선 후보자선전물이 게시되지 않았기에 어쩔 수 없이 2022년 진행된 8회 지선까지의 데이터를 가지고 프로젝트를 진행하였다.
<br/>
<br/>
<br/>
